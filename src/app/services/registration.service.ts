...
import { Usernameexists, Usersession } from '../models/usernameexists';
...
export class RegistrationService {
  ...
  login(occupant: Login): Observable<any> {
  ...
  isvalidsession(occupant: Usersession): Observable<Usersession> {
    return this.http.post<Usersession>(environment.apiUrl + 'isvalidsession', occupant, httpOptions).pipe(
      tap((occup: Usersession) => this.log(`isvalidsession w/ id=${occup}`)),
